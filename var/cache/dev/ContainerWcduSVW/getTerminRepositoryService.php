 ...
 */
class getTerminRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TerminRepository' shared autowired service.
     *
     * @return \App\Repository\TerminRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TerminRepository.php';

        return $container->privates['App\\Repository\\TerminRepository'] = new \App\Repository\TerminRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
