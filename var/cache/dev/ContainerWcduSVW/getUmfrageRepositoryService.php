 ...
 */
class getUmfrageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UmfrageRepository' shared autowired service.
     *
     * @return \App\Repository\UmfrageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UmfrageRepository.php';

        return $container->privates['App\\Repository\\UmfrageRepository'] = new \App\Repository\UmfrageRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
